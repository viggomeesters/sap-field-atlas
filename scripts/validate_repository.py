...
REQUIRED_PUBLIC_REPO_FILES = [
    ...
    "docs/ROADMAP.md",
    "docs/templates/atlas-fill-task.md",
    "docs/templates/go-loop-atlas-campaign.md",
    "scripts/atlas_gap_report.py",
    "skills/fill-atlas-gap-loop.md",
    ".github/pull_request_template.md",
    ".github/ISSUE_TEMPLATE/fill-atlas-gap.md",
